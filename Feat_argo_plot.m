%% This code will input an excel file that states all the ARGO float data
% that need to be plotted for the SMC full branch. This requires some
% data preperation (be sure that you have removed the duplicacy involved in
% the files)
...
plot_dir = '/projects/bobble/FORMS/ARGO';
plot_dir = [plot_dir filesep 'SMC_Main_Branch' filesep 'Full_plot'];
if(~exist(plot_dir))
    mkdir(plot_dir);
end
