...
filename = [ARGO_dir filesep 'along_prof_v2.txt'];
...
xlabel('Temp(\circ C)');
ylabel('Depth(m)');
l1 = legend('12-06-2016','12-07-2016','02-07-2016','22-06-2016','23-07-2016');
set(l1,...
...
xlabel('Salt(psu)');
ylabel('Depth(m)');
l2 = legend('12-06-2016','12-07-2016','02-07-2016','22-06-2016','23-07-2016');
set(l2,...
...
suptitle('Along SMC');
filename_save = 'SMC_Main_branch_ed2';
